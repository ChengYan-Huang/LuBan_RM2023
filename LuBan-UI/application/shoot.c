...
void shoot_init(void)
{
    ...
    ramp_init(&shoot_control.fric1_ramp, SHOOT_CONTROL_TIME * 0.01f, FRIC_DOWN, FRIC_OFF);
    ramp_init(&shoot_control.fric2_ramp, SHOOT_CONTROL_TIME * 0.01f, FRIC_DOWN, FRIC_OFF);
...
static void shoot_set_mode(void)
{
    ...
    if(!toe_is_error(REFEREE_TOE) && get_game_state() == 4 && (shoot_control.heat + SHOOT_HEAT_REMAIN_VALUE > shoot_control.heat_limit))
    {
