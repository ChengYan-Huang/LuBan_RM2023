...
/*********************************************自瞄控制****************************************************/
	static uint8_t autoaim_flag = 0;
	if(gimbal_control_set->gimbal_rc_ctrl->key.v & AUTOAIM_KEYBOARD_ON)
	{
		if(autoaim_flag == 0)
		{	
			autoaim_flag = 1;
	...
	else if(gimbal_control_set->gimbal_rc_ctrl->key.v & AUTOAIM_KEYBOARD_OFF)
	{
		autoaim_flag = 0;
